...
print(f"O plano basico faturou R$ {basico*planos['basico']:.2f}")
print(f"O plano medio faturou R$ {medio*planos['medio']:.2f}")
print(f"O plano completo faturou R$ {completo*planos['completo']:.2f}")
